          ...
          <div className="flex items-start gap-4 w-full p-1">
            ...
            <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
              <div className="flex items-center justify-between">
                ...
                <button className="md:hidden flex items-center gap-2 text-red-400 bg-red-50 border border-zomato-400 px-2 py-1 rounded-lg" onClick={addFoodToCart}
            ...
            <div className="hidden md:block w-2/12">
              <button className="flex items-center gap-2 text-red-400 bg-red-50 border border-zomato-400 px-2 py-1 rounded-lg" onClick={addFoodToCart}
                  disabled={food?.isAddedToCart}>
                {food.isAddedToCart ? (
                  "Added"
                ) : (
